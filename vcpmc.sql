...
INSERT INTO `lichsudoisoatdetails` (`id`, `name`, `luotPhat`, `doanhThu`, `bieuDien`, `sanXuat`, `vcpmc`, `createdAt`, `updatedAt`) VALUES
(1, 'Let Us Be', 365, '365.000.000', '36.266', '36.266', '36.200', '2023-07-09 19:17:29', '2023-07-09 19:17:29'),
(2, 'Be Alone', 250, '250.000.000', '2500', '2510', '2540', '2023-07-09 19:17:29', '2023-07-09 19:17:29'),
(3, 'Gene', 425, '425.000.000', '1427', '1400', '1600', '2023-07-09 19:17:29', '2023-07-09 19:17:29'),
(4, 'Remeber Us This Way', 400, '400.000.000', '4000', '4069', '4089', '2023-07-09 19:17:29', '2023-07-09 19:17:29'),
(5, 'Kill This Love', 280, '280.000.000', '5434', '5214', '5384', '2023-07-09 19:17:29', '2023-07-09 19:17:29');

INSERT INTO `ppdtdetaillefts` (`Id`, `name`, `luotPhat`, `doanhThu`, `hanhChinhPhi`, `nhuanBut`) VALUES
...
INSERT INTO `ppdtdetailrights` (`Id`, `name`, `luotPhat`, `doanhThu`) VALUES
...
INSERT INTO `feedbacks` (`id`, `user`, `topicId`, `desc`, `createdAt`, `updatedAt`) VALUES
(1, 'Thy Phạm', 2, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Euismod iaculis metus, nisl risus urna morbi risus. Blandit tempor, ac eu ut volutpat adipiscing aliquam. Habitasse a semper cras non. Laoreet nibh et, erat sit curabitur sapien, commodo.\r\nAccumsan ', '2023-07-09 12:48:58', '2023-07-09 12:48:58'),
(2, 'Thy Phạm', 3, 'Purus porta habitant tempor etiam rhoncus vitae amet, vulputate. Sed nisl sodales ullamcorper suspendisse id massa. ', '2023-07-09 12:55:59', '2023-07-09 12:55:59');
